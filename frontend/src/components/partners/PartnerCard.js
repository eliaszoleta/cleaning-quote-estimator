      ...
      <div style={{ display: 'flex', gap: 9, flexWrap: 'wrap' }}>
        ...
        {partner.website && (
          <a
            ...
            style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#2563eb', color: 'white', padding: '9px 18px', borderRadius: 8, textDecoration: 'none', fontWeight: 700, fontSize: 13.5 }}
          >
        ...
        {partner.email && (
          <a
            ...
            style={{ display: 'inline-flex', alignItems: 'center', gap: 6, border: '1.5px solid #cbd5e1', color: '#374151', padding: '9px 18px', borderRadius: 8, textDecoration: 'none', fontWeight: 600, fontSize: 13.5, background: 'white' }}
          >
            <Mail size={13} /> Email
          </a>
        )}
