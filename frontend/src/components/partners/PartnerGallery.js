...
const SLIDES = [
  ...
  { src: '/images/partner-gallery/Screenshot_452.png', title: 'Real visitors, real traffic', desc: '63k active users and 298k events over recent months — consistent with the 20–30K monthly visitors above, straight from Google Analytics.' },
];
