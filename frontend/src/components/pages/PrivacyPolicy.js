...
export default function PrivacyPolicy() {
  return (
    <>
      <Helmet><title>Privacy Policy | CleanCalc</title></Helmet>
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px', lineHeight: 1.8 }}>
        ...
        {[
          ...
          ['Your Rights', 'You have the right to request deletion of any personal information we hold about you. Contact us at privacy@cleaningcalculator.app and we will delete your data within 30 days.'],
          ...
          ['Changes', 'We may update this policy occasionally. Continued use of CleanCalc after changes constitutes acceptance of the updated policy.'],
          ['Contact', 'For privacy-related questions, email privacy@cleaningcalculator.app.'],
        ].map(([title, body]) => (
