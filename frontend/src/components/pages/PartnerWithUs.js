    ...
    <>
      ...
      <div style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e3a8a 100%)', color: 'white', padding: 'clamp(60px, 10vw, 100px) 24px' }}>
        <div style={{ maxWidth: 780, margin: '0 auto', textAlign: 'center' }}>
          <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 100, padding: '6px 18px', fontSize: 13, fontWeight: 600, marginBottom: 24, letterSpacing: '0.04em' }}>LIMITED SPOTS PER CITY</div>
          ...
          <a href="#apply" style={{ display: 'inline-block', background: PRIMARY, color: 'white', padding: '15px 36px', borderRadius: 10, textDecoration: 'none', fontWeight: 800, fontSize: 17, letterSpacing: '-0.2px' }}>Get My City &rarr;</a>
        </div>
      </div>
      ...
      <div style={{ padding: 'clamp(48px, 8vw, 80px) 24px', background: '#f8fafc' }}>
        <div style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
            <StepCard number="1" title="You choose your city (or cities)" desc="Tell us which cities or metro areas you serve. Each city is $350/month and gives you exclusive placement there &mdash; only one partner per city." />
            ...
            <StepCard number="3" title="Your business appears on estimate results" desc="When someone in your city finishes using our estimator, your contact card shows up on their results page as a recommended local cleaner &mdash; right when they're ready to book." />
        ...
        <div style={{ maxWidth: 580, margin: '0 auto' }}>
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 16, padding: 'clamp(24px, 4vw, 40px)' }}>
              ...
              <button type="submit" style={{ width: '100%', background: PRIMARY, color: 'white', border: 'none', borderRadius: 10, padding: '14px 0', fontWeight: 800, fontSize: 16, cursor: 'pointer' }}>Send My Application &rarr;</button>
